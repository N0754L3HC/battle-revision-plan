...
- Formatting tools available in feedback/fix/summary: LaTeX maths ($…$, $$…$$), fenced code blocks (\`\`\`lang), markdown tables, **bold**, and bullet lists. Use whichever fits the subject; keep ordinary explanation as plain words.
