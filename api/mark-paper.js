...
- Computer Science: mark code/pseudocode and structured answers — correctness, logic, edge cases, efficiency/Big-O, trace tables, correct terminology. Put their code/answer line-by-line in yourWorking (status-tag the buggy line) and a correct version in modelWorking. Format code clearly.
...
- Essays / extended writing (English, History, RS, Geography, Psychology, Sociology, Business): mark by the board's Assessment Objectives / levels of response — argument, structure, evidence/quotes, analysis, evaluation, conclusion. Do NOT use yourWorking/modelWorking; give detailed feedback per AO/section and concrete upgrades in "fix". You MAY use modelWorking as a short bulleted outline of what a top-band answer includes.
