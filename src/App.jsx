...
import { T, FONT_BODY, FONT_DISPLAY, FONT_MONO, type, ls, ensureAnimStyles } from './theme';
import { EXAM_SCHEDULE } from './data/examSchedule';
import CompanionAvatar, { CAPY_COATS, OUTFIT_COLORS } from './components/CompanionAvatar';
import { MathText, RichText } from './lib/richtext';
...
const _BANNED_SUB = /(nigger|nigga|niglet|faggot|wetback|beaner|golliwog|towelhead|raghead|bitch|fuck|shit|wank|twat|slut|whore|bollock|arsehole|asshole|pussy|jizz|dildo|paedo|molest)/;
const _BANNED_WB  = /\b(coons?|chinks?|gooks?|kikes?|spics?|pakis?|wogs?|fags?|dykes?|trann(y|ies)|cunts?|fuk|pricks?|slags?|bastards?|piss|rape|rapists?|pedos?|nonces?|incest|porn|cum|anal|penis|hitler|nazis?|kkk)\b/;
...
// ── Exam schedule ──────────────────────────────────────────────────────────
// Lives in data/examSchedule.js; re-exported here for back-compat imports.
export { EXAM_SCHEDULE } from './data/examSchedule';
...
// Root-rendered surfaces (lazy-loaded by Root.jsx - the thin entry shell).
export { RevisionPlan, LevelPicker, PlanPicker };
