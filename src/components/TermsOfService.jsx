  ...
  return (
    <div style={S.overlay} onClick={e => { if (e.target === e.currentTarget && onClose) onClose(); }}>
      <div style={S.box}>
        ...
        <div style={S.body}>
          <p style={S.p}>
            Welcome to <strong style={{ color: '#fff' }}>Battle Plan</strong> ("the App"), an A-Level and GCSE
          ...
          <p style={S.p}>
            Battle Plan is an independent revision tracking application built for UK A-Level and GCSE students.
          ...
          <p style={S.p}>
            The core App is free. <strong style={{ color: '#ddd' }}>Battle Plan Pro</strong> is an optional paid
